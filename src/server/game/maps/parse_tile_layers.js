...
var GetFastValue = require('phaser/src/utils/object/GetFastValue');
var LayerData = require('phaser/src/tilemaps/mapdata/LayerData');
var ParseGID = require('phaser/src/tilemaps/parsers/tiled/ParseGID');
var Tile = require('phaser/src/tilemaps/Tile');

function Base64Decode(data) {
  let buffer = new Buffer(data.trim(), 'base64')
  let expectedCount = buffer.length
  let gids = []
  for (var i = 0; i < expectedCount; i += 4) {
    gids.push(buffer.readUInt32LE(i))
  }
  return gids
}
...
export default ParseTileLayers;
